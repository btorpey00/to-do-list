...
function renderTasks(taskArray) {
    ...
    for (let i = 0; i < taskArray.length; i++) {
        ...
        currentDueDate.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(taskArray[i].dueDate, 'MM/dd/yyy');
